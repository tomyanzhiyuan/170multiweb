...
<main class="container">
    ...
    <div class="home-content">
        ...
        <section class="excerpt">
            <h2>Dark Souls</h2>
            <p>The world of Dark Souls is a world of cycles. Kingdoms rise and fall, ages come and go, and even time can
                end and restart as the flame fades and is renewed. These cycles are linked to the First Flame, a
                mysterious manifestation of life that divides and defines separate states such as heat and cold, or life
                and death.</p>
        ...
        <section class="excerpt">
            <h2>Helldivers 2</h2>
            <p>Helldivers 2 is a 2024 cooperative third-person shooter game developed by Arrowhead Game Studios and
                published by Sony Interactive Entertainment for the PlayStation 5 and Windows. The game is the direct
                sequel to Helldivers (2015). Set in the 22nd century, the story follows the Helldivers, an elite force
        ...
        <section class="excerpt">
            ...
            <p>The New York Knickerbockers, commonly referred to as the New York Knicks, are an American professional
                ...
                plays its home games at Madison Square Garden, an arena they share with the New York Rangers of the
